defmodule Shortly.LinksTest do
  ...
  describe "links" do
    ...
    @valid_attrs %{url: "https://elixir-lang.org/"}
    @update_attrs %{url: "https://www.stord.com/"}
    ...
    test "get_redirect_link!/1 returns the url" do
      link = link_fixture()
      assert Links.get_redirect_link!(link.hash) == link
    end
